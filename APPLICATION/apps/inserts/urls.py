...
urlpatterns = [
    ...
    path('order_service/<num_order>', views.order_service, name="order_service"),
    path('save_result_intervention/<num_order>', views.save_result_intervention, name="save_result_intervention"),
]