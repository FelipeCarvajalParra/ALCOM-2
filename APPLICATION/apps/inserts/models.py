...
class Intervenciones(models.Model):
    ...
    cod_equipo_fk = models.ForeignKey(Equipos, on_delete=models.CASCADE, db_column='cod_equipo_fk')
...
class Actualizaciones(models.Model):
    ...
    num_orden_fk = models.ForeignKey('Intervenciones', on_delete=models.CASCADE, db_column='num_orden_fk', blank=True, null=True)
    num_parte_fk = models.ForeignKey('partsInventory.Inventario', on_delete=models.CASCADE, db_column='num_parte_fk')
