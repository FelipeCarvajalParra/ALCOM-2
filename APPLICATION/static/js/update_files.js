...
const partFileImageInput = document.getElementById('partFileImageInput');
const partFileSheetInput = document.getElementById('partFileSheetInput')
...
if (partFileImageInput) {
    partFileImageInput.addEventListener('change', function() {
        const app_name = this.getAttribute('data-app');
        const table = this.getAttribute('data-table');
        const field = this.getAttribute('data-field');
        const record_id = this.getAttribute('data-record');
...
if (partFileSheetInput) {
    partFileSheetInput.addEventListener('change', function() {
        const app_name = this.getAttribute('data-app');
        const table = this.getAttribute('data-table');
        const field = this.getAttribute('data-field');
        const record_id = this.getAttribute('data-record');
